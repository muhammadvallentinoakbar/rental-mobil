...
<body>
    ...
    <div class="panel">
        ...
        <div class="panel-head">
            ...
            <p>Perbarui informasi unit armada di bawah ini.</p>
        </div>
        ...
        <form action="/mobil/{{ $mobil->id }}" method="POST">
            ...
            <div class="field">
                ...
                <input type="text" id="nama_mobil" name="nama_mobil" value="{{ $mobil->nama_mobil }}" required>
            </div>

            <div class="field">
                <label for="merk">Merk</label>
                <input type="text" id="merk" name="merk" value="{{ $mobil->merk }}" required>
            </div>

            <div class="field field-row">
                <div>
                    <label for="tahun">Tahun</label>
                    <input type="number" id="tahun" name="tahun" value="{{ $mobil->tahun }}" required>
                </div>

                <div>
                    <label for="harga_sewa">Harga Sewa (Rp)</label>
                    <input type="number" id="harga_sewa" name="harga_sewa" value="{{ $mobil->harga_sewa }}" required>
                </div>
            </div>
